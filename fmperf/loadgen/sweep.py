...
from fmperf.utils.constants import RESULTS_DIR, RESULTS_ALL_FILENAME
...
for u in users:
    ...
    filename = os.path.join(RESULTS_DIR, result_filename)
...
outfile = os.path.join(RESULTS_DIR, RESULTS_ALL_FILENAME)
